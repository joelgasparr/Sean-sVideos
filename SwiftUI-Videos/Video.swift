...
struct VideoList{
    ...
    Video(imageName: "37-tips", title: "37 Tips for Jr. Software Developers", uploadDate: "October 4, 2020"),
    Video(imageName: "90-90", title: "The 90/90 Rule", uploadDate: "January 24, 2019"),
    Video(imageName: "2018-setup", title: "iOS Development - iMac Pro", uploadDate: "May 11, 2018"),
    ...
    Video(imageName: "macaw", title: "How to Create a Bar Chat in Swift", uploadDate: "May 7, 2019"),
    Video(imageName: "nav-controller", title: "iOS Navigation Controller Tutorial", uploadDate: "March 28, 2020"),
    Video(imageName: "portfolio", title: "15 iOS Developers Portfolios", uploadDate: "February 15, 2020"),
    ]
}
